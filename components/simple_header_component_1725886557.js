...
<template>
    <header id="header-section" class="w-full">
        <nav id="nav-bar" class="bg-purple-900 bg-opacity-30 backdrop-filter backdrop-blur-lg border-b border-purple-200 py-4 dark:bg-gray-900">
                ...
                <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
                    <ul id="nav-list" class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        <li id="nav-item-home">
                            <a
                                href="#"
                                class="block py-2 pl-3 pr-4 text-pink-200 bg-purple-700 rounded-lg lg:bg-transparent lg:text-pink-200 lg:p-0 dark:text-white hover:bg-purple-600 lg:hover:bg-transparent lg:hover:text-pink-100 transition-colors duration-200"
                                aria-current="page"
                            >
